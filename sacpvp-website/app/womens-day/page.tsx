...
export const metadata: Metadata = {
  ...
  description:
    "Celebrating Women's Day 2025 and embracing vulnerability in the property valuation profession. Join SACPVP in recognizing the contributions of women in property valuation.",
  keywords: [
    "Women's Day 2025",
    "SACPVP women's day",
