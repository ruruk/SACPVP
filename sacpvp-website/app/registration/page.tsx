...
export const metadata: Metadata = {
  ...
  keywords: "SACPVP registration, property valuer registration, South Africa property valuation certification",
}
    ...
    <div className={`container ${styles.registration}`}>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.sectionDescription}>
          This is to clarify the type of registration certificates issued by SACPVP for various registration categories.
        </p>
        ...
        <div className={styles.note}>
          <strong>NB:</strong> Candidate valuers are required to submit their academic progress report each year. Those
          who have completed their studies and still receiving 1 year certificate should submit certificate copies of
          their academic transcripts and certificates to <a href="mailto:lerato@sacpvp.co.za">lerato@sacpvp.co.za</a>.
        </div>
      </section>

      <section className={styles.section}>
        <h2 className={styles.sectionTitle}>Application Form for Registration</h2>
        <p className={styles.sectionDescription}>
          For registration as Professional Valuer, Professional Associated Valuer and Single Residential Property
          Assessor
        </p>
        ...
        <div className={styles.applicationNote}>
          ...
          <p>
            You will be required further on to UPLOAD "EXPERIENCE MATRIX – SUMMARY OF THE VARIETY AND NATURE OF ALL
            EXPERIENCE IN PROPERTY VALUATION" Please download the template, complete it, save as PDF or Word and then
            keep it ready to UPLOAD further on.
          </p>
          <Link href="/registrationTemplate.docx" className={styles.downloadButton}>
            <Download size={16} />
            Download Template
          </Link>
        </div>
