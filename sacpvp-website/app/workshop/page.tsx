...
export const metadata: Metadata = {
  ...
  keywords: "SACPVP workshops, property valuer training, South Africa valuation events, professional development",
}
...
export default function WorkshopProgram() {
  ...
  return (
    <div className={`container ${styles.workshopPage}`}>
      ...
      <p className={styles.venue}>Venue: Camblish Training Institute, 51 Harrison Street, Johannesburg, 2001</p>
